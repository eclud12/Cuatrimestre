            ...
            <div id="api_search_autocomplete" style="position:relative">
                ...
                <form class="form-inline ml-3">
                    <div class="input-group input-group-sm">
                        <input class="form-control form-control-navbar" type="search" placeholder="Search" aria-label="Search" name="nombre" v-model="palabra_a_buscar" v-on:keyup="autoComplete" v-on:keyup.enter="SubmitForm">
                        <div class="input-group-append">
                            <button id="miboton" ref="SubmitButtonSearch" class="btn btn-navbar" type="submit">
