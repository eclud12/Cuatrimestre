		...
		<div class="menu">
			...
			<div class="menu_contact">
				<div class="menu_phone d-flex flex-row align-items-center justify-content-start">
					<div>
						<div><img src="http://127.0.0.1:8000/asset/images/phone.svg" alt="https://www.flaticon.com/authors/freepik"></div>
					</div>
				...
				<div class="header_content d-flex flex-row align-items-center justify-content-start">
					...
					<div class="header_right d-flex flex-row align-items-center justify-content-start ml-auto">
						...
						<div class="cart"><a href="cart.html">
								<div><img class="svg" src="http://127.0.0.1:8000/asset/images/cart.svg" alt="https://www.flaticon.com/authors/freepik">
									<div>1</div>
								</div>
							</a></div>
						<!-- Phone -->
